...
* You must currently restrict the `network` values to networks that are both supported by the upstream `x402` package **and** configured with RPC URLs in Bindu. Refer to x402 network support: https://docs.cdp.coinbase.com/x402/network-support.
